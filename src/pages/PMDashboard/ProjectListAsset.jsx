...
import "./ProjectListAsset.css";

const ProjectListAsset = () => {
  ...
  // Project selection handlers - DISABLED for view-only
  const handleProjectSelection = (project) => {
    showNotification("View only mode - Project selection disabled", "error");
    return;
  };

  // Export selected projects - DISABLED for view-only
  const handleExportSelectedProjects = () => {
    showNotification("View only mode - Export disabled", "error");
    return;
  };

  // EXPORT HANDLERS - DISABLED for view-only
  ...
  return (
    <div className="asset-list-container">
      ...
      <div className="view-only-banner" style={{
        ...
        👁️ View Only Mode - You can only view asset information (Create, Edit, Delete, Export disabled)
      </div>
      ...
      <div className="content-wrapper">
        ...
        {/* Stats Grid - Click filters remain enabled */}
          ...
          <div className="export-left">
            ...
            <div className="project-selector-container">
              <button 
                ...
                onClick={() => showNotification("View only mode - Export disabled", "error")}
                disabled={true}
                style={{ opacity: 0.5, cursor: 'not-allowed' }}
              >
                <span>📁</span>
...
export default ProjectListAsset;