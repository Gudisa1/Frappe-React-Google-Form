...
// import { fetchSubmissions } from '../../api/datacollection'; // import the fetch function
...
//       console.log("Fetched Submissions:", result); // Log the fetched submissions for debugging
//     };
...
//             <li key={sub.name}>
//                 <span>{sub.name}</span>
//               <strong>{sub.reporting_form}</strong> - Submitted by: {sub.submitted_by||sub.owner} - Status: {sub.status}
//               <p>{sub.project}</p>
//                <button onClick={() => viewDetails(sub.name)}>
//                 View Details
//               </button>
//             </li>
//           ))}
